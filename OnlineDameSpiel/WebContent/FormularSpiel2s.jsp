...
<form id="formular" action="Anmeldung" method="get">
	...
	<label for="weiß">weiß</label><input type="radio" name="farbe" id="weiß" /><br/>
	<label for="schwarz">schwarz</label><input type="radio" name="farbe" id="schwarz" checked="checked"/><br/>
