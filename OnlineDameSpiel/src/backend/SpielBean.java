...
public class SpielBean implements iBediener, iDatenzugriff, Serializable {
	 ...
	 */
	public SpielBean(String name1, boolean ki1, String name2, boolean ki2) {
...
//	 playerRotation(player1, player2);
	 ...
	 */
	// @Override
	public int[] act(Spieler player1) {
//		
...
//				continueEnter("Ki am Zug druecke Enter");
				...
				kikoords[0]=kiarray[0].getPosY();
				kikoords[1]=kiarray[0].getPosX();
				kikoords[2]=kiarray[1].getPosY();
				kikoords[3]=kiarray[1].getPosX();
...
//			System.out.println(spielbrett);
	...
	public void loadSerialize(String filename) {
		iDatenzugriff serial = new DatenzugriffSerialisiert();
		try {
			SpielBean spiel = (SpielBean) serial.laden(filename, "ser");
